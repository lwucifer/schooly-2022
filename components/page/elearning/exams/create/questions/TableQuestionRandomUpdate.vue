          ...
          <app-table :heads="tableHeads" :data="dataExamChecked">
            ...
            <td slot="cell(number_question)" slot-scope="{ row }">
              <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center" v-if="row.random.level == 'EASY'">
    ...
    this.dataTable = {
      ...
      random: {
        ...
        settings: [
          {
            level: "easy",
            random: data && data.random && data.random.level == "EASY" ? data.random.random : 0
          },
          {
            level: "medium",
            random: data && data.random && data.random.level == "MEDIUM" ? data.random.random : 0
          },
          {
            level: "hard",
            random: data && data.random && data.random.level == "HARD" ? data.random.random : 0
          }
        ],
      },
    };
