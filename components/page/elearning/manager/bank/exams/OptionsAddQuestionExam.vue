  ...
  <div class="opt-add-question">
    <ul class="list-opt">
      <li
        ...
        v-if="(active == 'choice' || active == 'all') && getObjBankExamEdit.method != 'UPLOAD'"
      >
      ...
      <li
        ...
        v-if="(active == 'essay' || active == 'all') && getObjBankExamEdit.method != 'UPLOAD'"
      >
        <a href=""><IconMode24px class="mr-2 icon" /> Tự luận</a>
      </li>
      <li 
        @click.prevent="handleBankQuestion"
        class="set-border-top"
        v-if="getObjBankExamEdit.method != 'UPLOAD'"
      >
