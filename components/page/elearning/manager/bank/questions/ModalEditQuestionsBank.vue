<template>
  <app-modal
    :width="666"
    :component-class="{ 'modal-create-bank create-question': true }"
    :footer="false"
  ...
  >
    <div slot="content" class="content">
        ...
        <div class="filter-form__item ml-0 mr-0">
          ...
          <div>
            <app-input
              ...
              :counter="150"
              v-model="payloadEditQuestionBank.name"
        ...
        <div class="d-flex-center">
          <div class="filter-form__item ml-0 mr-4">
            ...
            <app-vue-select
              ...
              :value="payloadEditQuestionBank.grade_id"
            ></app-vue-select>
          </div>
          <div class="filter-form__item ml-auto">
            ...
            <app-vue-select
              ...
              has-border
              :options="payloadEditQuestionBank.grade_id ? subjects : []"
              :reduce="(item) => item.id"
              @input="handleChangeSubject"
              :value="payloadEditQuestionBank.subject_id"
            ></app-vue-select>
          </div>
        </div>
      </div>
      ...
      <div class="row mt-3">
        <div
          class="col-3"
          @click="payloadEditQuestionBank.type = questionBankTypeArr[0]['id']"
        >
          <div
            :class="
              payloadEditQuestionBank.type == questionBankTypeArr[0]['id']
                ? 'active'
                : ''
            "
          >
        ...
        <div
          class="col-3"
          @click="payloadEditQuestionBank.type = questionBankTypeArr[1]['id']"
        >
          <div
            :class="
              payloadEditQuestionBank.type == questionBankTypeArr[1]['id']
                ? 'active'
                : ''
            "
          >
        ...
        <div
          class="col-3"
          @click="payloadEditQuestionBank.type = questionBankTypeArr[2]['id']"
        >
          <div
            :class="
              payloadEditQuestionBank.type == questionBankTypeArr[2]['id']
                ? 'active'
                : ''
            "
          >
        ...
        <div
          class="col-3"
          @click="payloadEditQuestionBank.type = questionBankTypeArr[3]['id']"
        >
          <div
            :class="
              payloadEditQuestionBank.type == questionBankTypeArr[3]['id']
                ? 'active'
                : ''
            "
          >
      ...
      <div class="row">
        <div
          class="col-3"
          @click="payloadEditQuestionBank.type = questionBankTypeArr[4]['id']"
        >
          <div
            :class="
              payloadEditQuestionBank.type == questionBankTypeArr[4]['id']
                ? 'active'
                : ''
            "
          >
        ...
        <div
          class="col-3"
          @click="payloadEditQuestionBank.type = questionBankTypeArr[5]['id']"
        >
          <div
            :class="
              payloadEditQuestionBank.type == questionBankTypeArr[5]['id']
                ? 'active'
                : ''
            "
          >
        ...
        <div
          class="col-3"
          @click="payloadEditQuestionBank.type = questionBankTypeArr[6]['id']"
        >
          <div
            :class="
              payloadEditQuestionBank.type == questionBankTypeArr[6]['id']
                ? 'active'
                : ''
            "
          >
...
import { questionBankTypeArr, useEffect } from "~/utils/common";
...
export default {
  ...
  mounted() {
    useEffect(this, this.getQuestionBank.bind(this), ["question_bank_id"]);
    useEffect(this, this.handleChangeQuestionBank.bind(this), ["questionBank"]);
  },

  watch: {
    "payloadEditQuestionBank.grade_id": {
      handler: function() {
        const params = {
          school_id: get(this, "userLogin.organization.id", ""),
          grade: this.payloadEditQuestionBank.grade_id,
        };
        this.$store.dispatch(
  ...
  methods: {
    ...
    async getQuestionBank() {
      const res = await this.$axios({
        url: `/elearning/teaching/manage/question_bank/${this.question_bank_id}`,
      });
      this.questionBank = res.data.data;
    },

    handleChangeQuestionBank() {
      this.payloadEditQuestionBank = { ...this.questionBank };
    },
    ...
    async handleAddQuestionBank() {
      ...
      try {
        const res = await this.$axios({
          url: `/elearning/teaching/manage/question_bank/${this.question_bank_id}`,
          method: "PUT",
          data: this.payloadEditQuestionBank,
        });
        this.submit = true;
    ...
    handleChangeSubject(subject_id) {
      this.payloadEditQuestionBank.subject_id = subject_id;
    },

    handleChangeGrade(grade_id) {
      this.payloadEditQuestionBank.grade_id = grade_id;
    },
    ...
    handleCheckName(value) {
      ...
      if (!get(this, "payloadEditQuestionBank.name", true)) {
        check = false;
        this.error.name = "Bạn cần nhập tiêu đề ngân hàng câu hỏi";
        return check;
      }

      if (get(this, "payloadEditQuestionBank.name.length", 0) > 150) {
        check = false;
        this.error.name =
