  ...
  <div class="create-question">
    ...
    >
      <div class="col-7">
        ...
        <div class="edit answer-tooltip" @click="handleEditContent('answer', index)">
          <span v-html="get(item, 'content', '')"></span>
          <IconEdit24
            class="icon-edit"
          />
          <div class="answer-text" v-if="get(item, 'content', false)">
      ...
      <div class="col-5">
        ...
        <div class="edit answer-tooltip" @click="handleEditContent('matching', index)">
          <span v-html="get(item, 'matching.content', '')"></span>
          <IconEdit24
            class="icon-edit"
          />
          <div class="answer-text" v-if="get(item, 'matching.content', false)">
            <div v-html="get(item, 'matching.content', '')"></div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    handleEditContent(type, index) {
      console.log('handle edit content: ', type, index);
