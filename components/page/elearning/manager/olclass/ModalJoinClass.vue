    ...
    <div slot="content" class="text-center" v-else>
      <div class="text-left">
        ...
        <div class="box12 border mb-4">
          <p class="mb-3" v-if="get(data, 'extra_info.assignment_type', '') == 'ELEARNING'">
            Tên bài giảng:
            <b>{{ get(data, "extra_info.assignment_name", "") }}</b>
          </p>
          <p class="mb-3" v-if="get(data, 'extra_info.assignment_type', '') == 'CLASS'">
            Tên lớp:
            <b>{{ get(data, "extra_info.assignment_name", "") }}</b>
          </p>
          <p class="mb-3" v-if="get(data, 'extra_info.assignment_type', '') == 'GROUP'">
            Tên nhóm:
            <b>{{ get(data, "extra_info.assignment_name", "") }}</b>
          </p>
