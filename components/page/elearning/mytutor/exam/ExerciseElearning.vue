...
import ElearningManagerFilterTable from "~/components/page/elearning/mytutor/exam/tables/Exercise"
import FilterForm from "~/components/page/elearning/mytutor/exam/forms/ExerciseFilter"
import ListTable from "~/components/page/elearning/mytutor/exam/tables/Exercise"
...
export default {
  ...
  methods: {
    ...
    //   this.updateFilter({ parent_id: val });
    // },
    handleChangedElearning(val) {
    ...
    async deleteItem() {
      try {
        ...
        if (get(res, 'success', false)) {
          ...
          this.$toasted.error(get(res, 'message', 'Xóa bài tập không thành công.'))
        }
      } catch (error) {
        console.log('error delete: ', error);
        this.$toasted.error("Xóa bài tập không thành công.");
      } finally {
