...
<script>
  ...
  import ChoiceQuestionDetail from "~/components/page/elearning/mytutor/exam/ChoiceQuestionDetail"
  import ChoiceQuestionList from "~/components/page/elearning/mytutor/exam/tables/ChoiceQuestionList"
