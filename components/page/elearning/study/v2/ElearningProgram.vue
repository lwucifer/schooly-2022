  ...
  <div class="e-program bg-white shadow-1">
    ...
    <div v-else-if="progress.type === 'COURSE'">
      <ElearningProgramCourse
        ...
        :key="index"
        :index="index"
        @showexercise="$emit('showexercise')"
      />
    </div>
    <div v-else>
...
import ElearningProgramItem from "~/components/page/elearning/study/v2/ElearningProgramItem";
import ElearningProgramCourse from "~/components/page/elearning/study/v2/ElearningProgramCourse";
...
export default {
  ...
  methods: {
    ...
    ...mapMutations("event", ["setStudyMode","setStudyCategory"]),
