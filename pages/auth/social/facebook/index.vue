<template> <h3 class="container">Đang chuyển hướng, vui lòng chờ...</h3></template>
...
export default {
  ...
  async mounted() {
    ...
    const loginFb = () => this.$store.dispatch("auth/loginFacebook", { code });
    const result = await loginFb();

    console.log("[loginFb] mounted", result);
