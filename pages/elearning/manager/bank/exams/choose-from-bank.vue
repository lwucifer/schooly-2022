...
export default {
  ...
  async fetch({ params, query, store }) {
    ...
    const type = !query.type || query.type == "MIX" ? null : query.type;
  ...
  computed: {
    ...
    sectionTitle() {
      const val = (this.$route && this.$route.query && this.$route.query.item_name) ? this.$route.query.item_name : this.getObjBankExamEdit.name;
      return val;
    }
  },
  ...
  methods: {
    ...
    handleRedirectExamBank() {
      ...
      const elearningId = this.$route.query
        ...
        : "";
        const from = this.$route.query ? this.$route.query.source : "";
      ...
      } else if (from == 'edit-exercise') {
        let url = `/elearning/manager/exams/${parent_id}/edit-exercise`;
        this.$router.push(url);
      } else if (from == 'edit-test') {
        let url = `/elearning/manager/exams/${parent_id}/edit-test`;
        this.$router.push(url);
