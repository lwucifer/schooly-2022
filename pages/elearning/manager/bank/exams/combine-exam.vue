    ...
    <div class="row">
      ...
      <div class="col-md-9">
        ...
        <div class="template-content">
          ...
          <TableEditCombineExam :dataDetailExam="filterExamMix" @bankExamEditSuccess="bankExamEditSuccess" />
...
import TableEditCombineExam from "~/components/page/elearning/manager/bank/exams/TableEditCombineExam";
...
export default {
  ...
  computed: {
    ...mapState("elearning/manager/bank/exam", ["getDetailBankExamMix", "getObjBankExamEdit"]),
    filterExamMix() {
      return (
