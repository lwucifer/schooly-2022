...
<script>
  ...
  import AddExercise from "~/components/page/course/create/exercise/v2/AddExercise";
  ...
  export default {
    ...
    methods: {
      handleDoneAddExercise(info) {
        this.$router.push(`/elearning/manager/exams/${info.id}/edit-exercise`)
      },
      cancelCreating() {
