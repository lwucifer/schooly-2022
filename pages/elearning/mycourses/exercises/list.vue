            ...
            <div class="elearning-manager-content p-0">
              <div class="elearning-manager-content__main py-2">
                ...
                <filter-form
                  ...
                  @changedGroup="handleChangedGroup"
...
<script>
  ...
  import FilterForm from "~/components/page/elearning/mycourses/forms/ExerciseFilter"
  import ListTable from "~/components/page/elearning/mycourses/tables/Exercise"
  ...
  export default {
    ...
    methods: {
      ...
      handleChangedClass(val) {
        this.updateFilter({ class_id: val, group_id: null })
      },
      handleChangedGroup(val) {
        this.updateFilter({ group_id: val, class_id: null })
      },
      submitFilter(val) {
