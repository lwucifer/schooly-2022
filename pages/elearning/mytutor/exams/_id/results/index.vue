...
<script>
  ...
  const ChoiceSubmission = () => import('~/components/page/elearning/mytutor/exam/ChoiceResult')
  const EssaySubmission = () => import('~/components/page/elearning/mytutor/exam/EssayResult')
  const MixSubmission = () => import('~/components/page/elearning/mytutor/exam/MixResult')
